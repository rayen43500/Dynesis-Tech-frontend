...
import { useClientAccount, useChangeClientPassword, useUpdateClientAccount, getApiErrorMessage } from './clientAccountHooks';
...
export function ClientAccountPage() {
  ...
  const accountQuery = useClientAccount();
  ...
  return (
    <div className="client-messages-page">
      <h1 className="client-messages-page__title">{t('client.account.title')}</h1>

      <section className="client-message-card client-account-card" aria-label="Account settings">
      ...
      <section className="client-message-card client-account-card" aria-label="Change password">
