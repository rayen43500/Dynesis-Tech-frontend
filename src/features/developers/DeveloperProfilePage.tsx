...
function PortfolioOverlay({
  ...
  return (
    <div className="dev-overlay" role="dialog" aria-modal="true" aria-label={project.title}>
      <button type="button" className="dev-overlay__close" onClick={onClose} aria-label="Close">
        ×
      </button>
      ...
      <aside className="dev-overlay__details">
        ...
        {(
          ...
          <div key={label}>
            <p className="dev-overlay__section-label">{label}</p>
...
export function DeveloperProfilePage() {
  ...
  if (query.isLoading) return <LoadingState label="Loading developer profile…" />;

  if (query.isError || !query.data) {
    return (
      <div className="dev-profile">
        <EmptyState title="Developer not found" description="This profile may have been removed." badge="404" />
    ...
    <div className="dev-profile">
        ...
        <div>
          ...
          <div className="dev-profile__availability">
            <p className="dev-profile__availability-text">
              {firstName} is <strong>available</strong> for hire
            </p>
        ...
        <div>
          ...
          <div className="dev-profile__verified">
            ...
            <span className="dev-profile__verified-text">
              <span className="dev-profile__verified-strong">Verified Expert</span>
              <span className="dev-profile__verified-light"> in Engineering</span>
            </span>
          </div>
          ...
          <div className="dev-profile__info-row">
            <span aria-hidden>📅</span>
            Dynesis member since {developer.memberSince}
          </div>

          {expertiseTags.length > 0 ? (
            <>
              <p className="dev-profile__section-label">EXPERTISE</p>
          ...
          {biography ? (
            <>
              <p className="dev-profile__section-label">BIO</p>
      ...
      <section className="dev-profile__section">
        <div className="dev-profile__section-header">
          <h2 className="dev-profile__section-title">Portfolio</h2>
            ...
            return (
              ...
              >
                ...
                <div className="dev-project-card__pills">
                  ...
                  {extra > 0 ? (
                    <span className="dev-project-card__pill dev-project-card__pill--more">+ {extra} more</span>
                  ) : null}
                </div>
              </button>
            );
      ...
      <div className="dev-profile__share">
        <span className="dev-profile__share-label">SHARE</span>
        <button type="button" className="dev-profile__share-btn" aria-label="Share on Twitter">
          X
        </button>
        <button type="button" className="dev-profile__share-btn" aria-label="Share on Facebook">
          f
        </button>
        <button type="button" className="dev-profile__share-btn" aria-label="Share on LinkedIn">
          in
        </button>
      </div>
